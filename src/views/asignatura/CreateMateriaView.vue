        ...
        <div class="card-body">
          <form @submit="guardar">
            ...
            <div class="input-group mb-3">
              <input type="text" v-model="codigo_asignatura" id="nombres" class="form-control" maxlength="30"
                placeholder="Codigo Materia" required>
            </div>
            ...
            <div class="input-group mb-3">
              <input type="text" v-model="pre_requisito1" id="pre_requisito1" class="form-control" maxlength="50"
                placeholder="Pre Requisito1" required>
            </div>
