            ...
            <form @submit="guardar">
              <div class="input-group mb-3">
                ...
                <input
                  ...
                  :value="
                    ci_especial
                      ? `${ci_estudiante} ${ci_especial} ${extencion}`
                      : `${ci_estudiante} ${extencion}`
                  "
                  disabled
                />
              </div>
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Año que cursa:</span>
                </div>
                <select
                  class="form-select text-center"
                  id="anio_cursado"
                  v-model="anio_cursado"
                >
                  <option :value="anio_cursado" selected>
                    {{ anio_cursado }}
                  </option>
                  <option
                    v-for="anio in anios_carreras"
                    v-bind:value="anio.nombre_anio"
                    :key="anio.id"
                  >
                    {{ `${anio.nombre_anio}` }}
                  </option>
              ...
              <div class="input-group mb-3">
                ...
                >
                  <option :value="depa_nacimiento" selected>
                    {{ depa_nacimiento }}
                    <!-- ---Departamento Nacimiento--- -->
                  </option>
                  <option
                    v-for="departamento in departamentos"
                    v-bind:value="departamento.nombre_departamento"
                    :key="departamento.id"
                  >
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Provincia de nacimiento:</span>
                </div>
                <select
                  class="form-select text-center"
                  id="prov_nacimiento"
                  v-model="prov_nacimiento"
                >
                  <option :value="prov_nacimiento" selected>
                    {{ prov_nacimiento }}
                  </option>
                  <option
                    v-for="provincia in provincias"
                    v-bind:value="provincia.nombre_provincia"
                    :key="provincia.id"
                  >
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Nunicipio Nacimiento:</span>
                </div>
                <input
                  type="text"
                  v-model="munic_nacimiento"
                  id="munic_nacimiento"
                  class="form-control"
                  maxlength="100"
                />
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Modalidad ingreso:</span>
                </div>
                <input
                  type="text"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Idioma Nativo:</span>
                </div>
                <select
                  class="form-select text-center"
                  id="idioma_nativo"
                  v-model="idioma_nativo"
                >
                  ...
                  <option
                    ...
                    v-bind:value="idioma.nombre_idioma"
                    :key="idioma.nombre_idioma"
                  >
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Numero de Registro:</span>
                </div>
                <input
                  type="text"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Numero de archivo:</span>
                </div>
                <input
                  type="number"
                  v-model="numero_archivo"
                  id="numero_archivo"
                  class="form-control"
                  maxlength="100"
                />
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Homologado:</span>
                </div>
                <input
                  type="text"
                  v-model="homologacion"
                  id="homologacion"
                  class="form-control"
                  maxlength="100"
                />
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Estado homologado:</span>
                </div>
                <input
                  type="text"
                  v-model="estado_homologacion"
                  id="estado_homologacion"
                  class="form-control"
                  maxlength="100"
                />
              </div>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Convalidado:</span>
                </div>
                <input
                  type="text"
                  v-model="convalidacion"
                  id="convalidacion"
                  class="form-control"
                  maxlength="100"
                />
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Estado convalidado:</span>
                </div>
                <input
                  type="text"
                  v-model="estado_convalidacion"
                  id="estado_convalidacion"
                  class="form-control"
                  maxlength="100"
                />
              </div>
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"
                    >Titula a nivel Tecnico Superior:</span
                  >
                </div>
                <select
                  class="form-select text-center"
                  id="titulado_tecnico_superior"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"
                    >observación Titulado Tecnico Superior:</span
                  >
                </div>
                <input
                  type="text"
                  v-model="descripcion_titulado_superior"
                  id="descripcion_titulado_superior"
                  class="form-control"
                  maxlength="255"
                />
              </div>
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"
                    >Titulado a nivel LICENCIATURA :</span
                  >
                </div>
                <select
                  class="form-select text-center"
                  id="titulado_licenciatura"
                  v-model="titulado_licenciatura"
                >
                  <option value="si">Si</option>
                  <option value="no">No</option>
                </select>
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text"
                    >Observación Titulado Licenciatura:</span
                  >
                </div>
                <input
                  type="text"
                  v-model="descripcion_titulado_licenciatura"
                  id="descripcion_titulado_licenciatura"
                  class="form-control"
                  maxlength="255"
                />
              </div>
              ...
              <hr />
              <div class="input-group mb-3">OBSERVACIONES:</div>

              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Observación 1:</span>
                </div>
                <input
                  type="text"
                  v-model="obs1"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Observación 2:</span>
                </div>
                <input
                  type="text"
                  v-model="obs2"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Observación 3:</span>
                </div>
                <input
                  type="text"
                  v-model="obs3"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Descripción de estado :</span>
                </div>
                <input
                  type="text"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Baja estudiante :</span>
                </div>
                <select
                  class="form-select text-center"
                  id="baja"
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">Descripción de estado interno:</span>
                </div>
                <input
                  type="text"
                  v-model="descripcion_interno"
                  id="obs3"
                  class="form-control"
                  maxlength="100"
                />
...
export default {
  ...
  data() {
    return {
      ...
      egresado: "",
      estado_egresado: "",
      titulado_tecnico_superior: "",
      descripcion_titulado_superior: "",
      titulado_licenciatura: "",
      descripcion_titulado_licenciatura: "",
      numero_registro: 0,
      obs1: "",
      obs2: "",
      obs3: "",
  ...
  methods: {
    ...
    onChange(event) {
      axios
        .get(
          BASE_URL + "/parametros/obtenerProvincias/" + event.target.value + "/"
        )
        ...
        .then(
          (response) => (
            ...
            (this.estado_civil = response.data["estado_civil"]
              ? response.data["estado_civil"]
              : ""),
            (this.idioma_nativo = response.data["idioma_nativo"]
              ? response.data["idioma_nativo"]
              : ""),
            ...
            (this.titulado_tecnico_superior =
              response.data["titulado_tecnico_superior"]),
            (this.descripcion_titulado_superior =
              response.data["descripcion_titulado_superior"]),
            (this.titulado_licenciatura =
              response.data["titulado_licenciatura"]),
            (this.descripcion_titulado_licenciatura =
              response.data["descripcion_titulado_licenciatura"]),
            ...
            (this.interno = response.data["interno"]),
            (this.descripcion_interno = response.data["descripcion_interno"]),
    ...
    getIdiomas() {
      axios
        .get(BASE_URL + "/parametros/idiomasOriginarios/")
        .then((response) => (this.idiomas = response.data))
        .catch((error) => {
          show_alerta(error, "error");
        });
    },
    ...
    getCarreras() {
      axios
        .get(BASE_URL + "/parametros/carreras/")
    ...
    async getProvincias() {
      await axios
        .get(BASE_URL + "/parametros/provincias/")
        .then((response) => (this.provincias = response.data));
    },
    //metodo para obtener las gestiones académicas
    async getAnioCarrera() {
      await axios
        .get(BASE_URL + "/parametros/aniosCarreras/")
        .then((response) => (this.anios_carreras = response.data));
    },
    //metodo para obtener la lista de departamentos
    async getDepartamentos() {
      await axios
        .get(BASE_URL + "/parametros/departamentos/")
        .then((response) => (this.departamentos = response.data));
    },
    ...
    async guardar() {
      ...
      if (this.nombres.trim() === "") {
        ...
        const parametros = {
          ...
          descripcion_interno: this.descripcion_interno,
